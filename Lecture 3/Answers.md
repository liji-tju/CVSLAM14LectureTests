...
|              | 旋转矩阵(<a href="https://www.codecogs.com/eqnedit.php?latex=\mathbf{R}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\mathbf{R}" title="\mathbf{R}" /></a>) | 轴角 | 欧拉角 | 四元数 |
|:------------:|:-------:|:---:|:-----:|:------:|
| __旋转矩阵__ |     \    |     |       |        |
| __轴角__     |          |  \   |       |        |   
| __欧拉角__   |         |     |    \   |        |
